...
-- User embeddings table for AI context (using JSONB instead of vector)
...
-- Note: When pgvector is enabled, you can migrate embeddings from JSONB to vector type
-- ALTER TABLE user_embeddings ADD COLUMN embedding_vector vector(1536);
-- UPDATE user_embeddings SET embedding_vector = embedding::text::vector;
-- ALTER TABLE user_embeddings DROP COLUMN embedding;
-- ALTER TABLE user_embeddings RENAME COLUMN embedding_vector TO embedding; 